...
public class MontrealServerImplementation implements ServerInterface {
	...
	public Logger LOG = Logger.getLogger(MontrealServerImplementation.class.getName());
	...
	public MontrealServerImplementation() throws Exception {
		...
		createLoggingFile("Montreal");

//		eventInfo.put("CONFERENCES", new LinkedHashMap<String, Integer>());
//		eventInfo.get("CONFERENCES").put("MTLA100519", dummyCapacity);
//		eventInfo.get("CONFERENCES").put("MTLE100519", dummyCapacity);
//
//		eventInfo.put("SEMINARS", new LinkedHashMap<String, Integer>());
//		eventInfo.get("SEMINARS").put("MTLA100519", dummyCapacity);
//		eventInfo.get("SEMINARS").put("MTLE100519", dummyCapacity);
//
//		eventInfo.put("TRADE SHOWS", new LinkedHashMap<String, Integer>());
//		eventInfo.get("TRADE SHOWS").put("MTLA100519", dummyCapacity);
//		eventInfo.get("TRADE SHOWS").put("MTLE100519", dummyCapacity);
//
//		userInfo.put("MTLC2345", new LinkedHashMap<String, ArrayList<String>>());
//		userInfo.get("MTLC2345").put("CONFERENCES", new ArrayList<String>() {
//			{
//				add("MTLA100519");
//			}
//		});
//		userInfo.get("MTLC2345").put("SEMINARS", new ArrayList<String>() {
//			{
//				add("MTLA100519");
//			}
//		});
	...
	public synchronized String addEvent(String eventId, String eventType, int bookingCapacity) {
		...
		if ((eventId.subSequence(0, 3).toString()).equalsIgnoreCase("MTL")) {
	...
	public synchronized String removeEvent(String eventType, String eventId) {
		...
		if (eventPrefix.equalsIgnoreCase("MTL")) {
...
//		Printing other servers event availability using UDP 
		...
		reply = send("listeventmanager", eventType, null, ottawaPort, null, 0, null, null);
		message = message + reply + "\n";
...
//		Removing event record from userInfo map if available
		...
		if (foundFlag) {
			if (eventPrefix.equalsIgnoreCase("MTL")) {
//			Finding capacity for particular event and increasing by one
...
//				    book new event//			cancel old event
	...
	private boolean checkUserBookingLimit(String customerId, String eventId) {
		...
		for (String currEvent : currentUserEvents) {
			if (currEvent.substring(6, 8).equalsIgnoreCase(checkDate)
					&& !(currEvent.substring(0, 3).equalsIgnoreCase("MTL"))) {
				limitCounter++;
			}
		}
		if (limitCounter >= 3) {
	...
	String send(String key1, String eventType, String eventId, int serverPort, String userID, int capacity,
		...
		LOG.info("Montreal server sending request  " + key1 + " with Event Type: " + eventType + " Event Id: " + eventId
		...
		LOG.info("Montreal server got the respose back " + messageReceived);
