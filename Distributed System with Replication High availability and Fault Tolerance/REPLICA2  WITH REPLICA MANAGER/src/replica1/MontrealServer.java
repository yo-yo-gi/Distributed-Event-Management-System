...
public class MontrealServer {
	...
	public static Thread mtlThread=null;
	 public volatile static boolean running;
	 static DatagramSocket aSocket = null;
	 static MontrealServerImplementation monStub;

	public static void startMontrealServer() throws Exception {

		try {
			monStub = new MontrealServerImplementation();
	...
	public static void stopServer() {
		 if (mtlThread == null) return;
         running = false;
         aSocket.close();
         System.out.println("Montreal server shutting down");
	}
