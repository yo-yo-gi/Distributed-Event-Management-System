...
public class TorontoServer {
	...
	public static Thread torThread=null;
	 public volatile static boolean running;
	 static DatagramSocket aSocket = null;
	 static TorontoServerImplementation torStub ;

    public static void startTorontoServer() throws Exception {

		try {
			torStub = new TorontoServerImplementation();
			System.out.println("Toronto City Server ready and waiting ...");
			torThread=new Thread(() -> receiverequest(torStub));
			torThread.start();
		}catch (Exception e) {
			e.printStackTrace();
		}
    ...
    public synchronized static void stopServer() {
    	 if (torThread == null) return;
         running = false;
         aSocket.close();
         System.out.println("Toronto server shutting down");
	}
