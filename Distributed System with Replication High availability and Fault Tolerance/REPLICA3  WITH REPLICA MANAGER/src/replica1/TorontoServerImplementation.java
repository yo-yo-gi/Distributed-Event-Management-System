...
public class TorontoServerImplementation  implements ServerInterface {
...
//			    book new event//			cancel old event
	...
	String send(String key1, String eventType, String eventId, int serverPort, String userID, int capacity,
		...
		LOG.info("Toronto server sending request  " + key1 + " with Event Type: " + eventType + " Event Id: " + eventId
