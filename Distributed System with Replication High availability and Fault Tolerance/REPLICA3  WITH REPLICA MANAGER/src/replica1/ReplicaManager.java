...
/* things to change */	private static final int FEPORT=4002, CRASH_SERVER_PORT=9001, MULTICAST_RECEIVE_PORT=8001; 
...
//			throw new Exception("No operation matching");
	...
	private static void restartAfterCrash() throws Exception {
		...
		for (String currentRequest : requestQueue) {
			...
			System.out.println("Response crash execution: "+response);
