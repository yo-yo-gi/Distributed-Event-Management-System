...
/**
* customerBookingApp/_CustomerManagerInterfaceStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from CustomerManager.idl
* Friday, 2 August, 2019 12:23:53 AM EDT
*/

public class _CustomerManagerInterfaceStub extends org.omg.CORBA.portable.ObjectImpl implements customerBookingApp.CustomerManagerInterface
{
  ...
  public String addEvent (String userId, String eventID, String eventType, String capacity)
  {
            ...
            try {
                ...
                return addEvent (userId, eventID, eventType, capacity        );
            } finally {
                _releaseReply ($in);
            }
  } // addEvent
  ...
  public String removeEvent (String userId, String eID, String eType)
  {
            ...
            try {
                ...
                return removeEvent (userId, eID, eType        );
            } finally {
                _releaseReply ($in);
            }
  } // removeEvent
  ...
  public String bookEvent (String userId, String custID, String eID, String eType)
  {
            ...
            try {
                ...
                return bookEvent (userId, custID, eID, eType        );
            } finally {
                _releaseReply ($in);
            }
  } // bookEvent
  ...
  public String getBookingSchedule (String userId, String customerID)
  {
            ...
            try {
                ...
                return getBookingSchedule (userId, customerID        );
            } finally {
                _releaseReply ($in);
            }
  } // getBookingSchedule

  public String cancelEvent (String userId, String customerID, String eventID, String eventType)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                return cancelEvent (userId, customerID, eventID, eventType        );
            } finally {
                _releaseReply ($in);
            }
  } // cancelEvent
  ...
  public String swapEvent (String userId, String custID, String newEventID, String newEventType, String oldEventID, String oldEventType)
  {
            ...
            try {
                ...
                return swapEvent (userId, custID, newEventID, newEventType, oldEventID, oldEventType        );
            } finally {
                _releaseReply ($in);
            }
  } // swapEvent
...
} // class _CustomerManagerInterfaceStub
