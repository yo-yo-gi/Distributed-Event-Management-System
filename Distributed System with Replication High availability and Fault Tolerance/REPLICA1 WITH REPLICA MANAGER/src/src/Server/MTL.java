...
public class MTL implements ServerInterface{
	    ...
	    public MTL() throws Exception {
	        ...
	        Server = "MTL";
	        OtherServers = "TOR,OTW";
	        Serverlog = new Logger("MTLServer.log");
	        Serverlog.WriteLog(" MTL Server has started");
	        UDPPort = 3333;
	        running = true;
	        Runnable task = () -> {
	            try {
	   ...
	   /* public static void startMontrealServer() throws Exception {
			...
			try {
				...
				mtlThread =new Thread(() -> receiverequest(monStub));
				mtlThread.start();
			}catch (Exception e) {
				e.printStackTrace();
			}
	   ...
	   /* public static void main(String[] args) throws Exception{
	        ...
	        registry.bind("MTL",ms);
	        System.out.println("MTL RMI Server has started, port 3000");
	    }*/
	}
