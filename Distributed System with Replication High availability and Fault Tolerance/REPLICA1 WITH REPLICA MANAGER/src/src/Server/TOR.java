...
public class TOR implements ServerInterface{
	    ...
	    public TOR() throws Exception {
	        ...
	        Server = "TOR";
	        OtherServers = "MTL,OTW";
	        Serverlog = new Logger("TORServer.log");
	        Serverlog.WriteLog(" TOR Server has started");
	        UDPPort = 4444;
	        Runnable task = () -> {
	            try {
	                receive();
	   ...
	   /* public static void main(String[] args) throws Exception {
	        Registry registry;
	        TOR_Server tor = new TOR_Server();
	        registry = LocateRegistry.createRegistry(4000);
	        registry.bind("TOR",tor);
	        System.out.println("TOR RMI Server has started, port "+ 4000);
