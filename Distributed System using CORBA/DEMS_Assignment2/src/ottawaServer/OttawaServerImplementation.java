...
public class OttawaServerImplementation extends IDLInterfacePOA{
...
//			cancel old event//		    book new event
    ...
    LOG.info("Ottawa server sending request  "+key+" with Event Type: "+eventType+" Event Id: "+eventId+" Server Port: "+serverPort+" User Id: "+userID+" Capacity: "+capacity+ " Old Event Type: " + oldEventType + " Old Event Id: " + oldEventId);
...
//		Check if new event is valid and its capacity not zero
		if (newEventPrefix.equalsIgnoreCase("OTW")) {
