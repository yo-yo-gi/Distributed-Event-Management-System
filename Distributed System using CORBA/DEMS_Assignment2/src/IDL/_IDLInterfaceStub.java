...
public class _IDLInterfaceStub extends org.omg.CORBA.portable.ObjectImpl implements IDL.IDLInterface
{
  ...
  public String removeEvent (String managerId, String eventId)
  {
            ...
            try {
                ...
                return removeEvent (managerId, eventId        );
            } finally {
                _releaseReply ($in);
            }
  } // removeEvent
